...
function hight_vending_setup() {
	/*
		...
		* If you're building a theme based on Hight Vending, use a find and replace
		* to change 'hight-vending' to the name of your theme in all the template files.
		*/
...
function hight_vending_scripts() {
	wp_enqueue_style( 'hight-vending-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'hight-vending-style', 'rtl', 'replace' );

	wp_enqueue_script( 'hight-vending-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
